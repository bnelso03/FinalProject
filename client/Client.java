...
public class Client {
  ...
  public static void sendTask(Socket socket, int[] data, String sort) throws IOException { // sends the List object over
                                                                                           // to port
  ...
  // Originally returned a list, but sending objects instead of primitive types
  // ended up being like 100x slower
